...
• Validação via Software Bare-Metal: Ainda em simulação, será escrito um pequeno 
programa em linguagem C (sem sistema operacional) que escreve matrizes fictícias nos 
endereços mapeados da NPU e verifica se o resultado acumulado lido no registrador de 
saída está matematicamente correto.
